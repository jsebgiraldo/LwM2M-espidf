...
IGNORE_PATTERNS = list(map(re.compile, [
    ...
    '^NOTICE$',
    '^doc/sphinx/make.bat$',
    '^doc/sphinx/source/avsystem_header.png$',
    '^doc/sphinx/source/conf.py.in$',
    '^tests/fuzz/input/coap_parse/empty$',
    '^tests/fuzz/input/hex-to-fuzz-input.sh$',
    '__pycache__',
    'deps/avs_commons',
    'tests/fuzz/input/coap_async_api_',
    'tools/conditional_headers_whitelist.json',
]))

SUBMODULES = ['deps/avs_commons']
